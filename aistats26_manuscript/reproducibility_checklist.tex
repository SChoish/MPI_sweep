...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \textbf{Yes.} Section~\ref{sec:method} states that BAR uses $K$ persistent actors and $K$ actor optimizer calls per delayed update; Eq.~\eqref{eq:margin}, Proposition~\ref{prop:exposure}, and the local-idealization subsection state the theoretical properties and scope. The supplement reports a verified one-stack time and memory profile.
