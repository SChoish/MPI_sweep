...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \textbf{No.} All recoverable settings are listed, but exact per-run BAR-P4 configurations and manifests for proximal seeds 2--3 are unavailable.
    ...
    \textbf{Yes.} Captions and text define the equally task-and-budget-weighted high-budget estimand, seed-mean cells, raw seeded runs, collapse thresholds, paired ratios, and task-resampling intervals. The proximal grid uses four seeds in two host-separated pairs; the linearized grid and mechanism audits use two.
