...
| `inventory_p0_hop_actors.py` / `eval_p0_hop_actors.py` / `diagnose_p0_hop_actions.py` / `analyze_p0_hop_actors.py` | P0 K=4 hop-actor CPU eval and common-state action audit |
