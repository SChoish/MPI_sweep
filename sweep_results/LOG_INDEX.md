...
| [STATUS.json](iql_gauss_fr_loco/STATUS.json) | Gaussian Q+BC–FR (본문 제외) | choi (계정) | 6/3924 | 6 | 0 | 2026-09-23 15:35:04 KST |
| [STATUS.json](iql_gauss_fr_s0/STATUS.json) | Gaussian Q+BC–FR (본문 제외) | ext_csh (계정) | 124/1188 | 124 | 0 | — |
| [STATUS.json](iql_gauss_v5/STATUS.json) | Gaussian Q+BC–W2 | choi (계정) | 315/360 | 1410 | 315 | 2026-09-23 15:35:04 KST |
| [STATUS.json](iql_k4_t6/STATUS.json) | AWR–FR, Deterministic Q+BC–W2 (본문 제외), Gaussian Q+BC–W2 | shchoi (계정) | 345/540 | 3126 | 650 | 2026-09-23 15:34:06 UTC+09:00 |
...
| [STATUS.json](iql_qbc_gaussian_w2_hc_walker_s0123/STATUS.json) | Gaussian Q+BC–W2 | DGX-H200-02, ext_csv | 720/720 | 720 | 720 | 2026-09-23T06:35:54Z |
...
| sweep_results/iql_gauss_v5 | [scores.csv](iql_gauss_v5/scores.csv) (1410) | 315 → 315 |
| sweep_results/iql_k4_t6 | [scores_long.csv](iql_k4_t6/scores_long.csv) (3126) | 1012 → 650 |
